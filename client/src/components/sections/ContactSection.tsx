    ...
    <section id="contact" className="py-24 bg-white dark:bg-slate-950">
      <div className="container">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="reveal grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
            {/* Email */}
            <a
            ...
            >
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 font-mono">gusxkrtkfkd@gmail.com</p>
            ...
            <a
              ...
              className="group p-8 bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-xl hover:border-slate-400 dark:hover:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all duration-300 hover:-translate-y-2 text-center"
            >
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 font-mono">github-janalai3395</p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group p-8 bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-xl hover:border-pink-300 dark:hover:border-pink-700 hover:bg-pink-50 dark:hover:bg-pink-950 transition-all duration-300 hover:-translate-y-2 text-center"
            >
              <div className="w-14 h-14 bg-pink-50 dark:bg-pink-950 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-pink-200 dark:group-hover:bg-pink-800 transition-all duration-300 group-hover:scale-110">
                <Instagram className="w-7 h-7 text-pink-600 dark:text-pink-400 group-hover:text-pink-700 dark:group-hover:text-pink-300 transition-colors" />
              </div>
              <h3 className="font-bold text-slate-900 dark:text-white mb-1">Instagram</h3>
              <p className="text-sm text-slate-500 dark:text-slate-400 font-mono">@gusxkrtkfkd</p>
