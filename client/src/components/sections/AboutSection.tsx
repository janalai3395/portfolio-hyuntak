    ...
    <section id="about" className="py-24 bg-slate-50 dark:bg-slate-900">
      <div className="container">
        ...
        <div className="reveal mb-16">
          <p className="text-sm font-mono text-blue-600 dark:text-blue-400 mb-2 tracking-widest uppercase">01. About</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="reveal">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <p className="text-xs font-mono text-slate-400 dark:text-slate-500 uppercase tracking-wider">Developer</p>
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">김현탁</h3>
              </div>
            </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              <div className="p-4 bg-white dark:bg-slate-800 rounded-lg border border-slate-100 dark:border-slate-700">
                <p className="text-xs text-slate-400 dark:text-slate-500 font-mono mb-1">학번</p>
                <p className="font-semibold text-slate-800 dark:text-white">202395013</p>
              </div>
              <div className="p-4 bg-white dark:bg-slate-800 rounded-lg border border-slate-100 dark:border-slate-700">
              ...
              <div className="p-4 bg-blue-50 dark:bg-blue-950 rounded-lg border border-blue-100 dark:border-blue-800 col-span-2">
                ...
                <p className="font-semibold text-blue-800 dark:text-blue-300">백엔드 개발자</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {HIGHLIGHTS.map((item, i) => (
              <div
                key={item.title}
                className={`reveal p-6 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-md hover:border-blue-200 dark:hover:border-blue-700 transition-all duration-300`}
